...
/*Дадена е матрица от числа m x n (напр.: 7 x 8). 
Дадена е и подматрица  от числа k x k, където k <= min(m,n).
Да се намери максималната сума от елементи k x k в m x n (напр.: кои 3x3 числа сумарно дават максимален резултат).
Вход: m,n, k
Изход: maxSum*/
